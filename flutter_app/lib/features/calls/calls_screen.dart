...
class _CallsScreenState extends ConsumerState<CallsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    calls = switch (filter) {
      'inbound' =>
        calls.where((c) => c.direction == CallDirection.inbound).toList(),
      'outbound' =>
        calls.where((c) => c.direction == CallDirection.outbound).toList(),
      'missed' => calls.where((c) => c.missed).toList(),
      'voicemail' =>
        calls.where((c) => c.finalState == CallState.voicemail).toList(),
