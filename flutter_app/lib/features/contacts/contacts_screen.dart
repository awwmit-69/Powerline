            ...
            if (dupes.isNotEmpty)
              FilledButton.icon(
                style: FilledButton.styleFrom(
                  backgroundColor: PowerlineColors.stateRinging,
                ),
            ...
            itemBuilder: (c, i) {
              ...
              return ListTile(
                ...
                leading: CircleAvatar(
                  radius: 14,
                  child: Text(
                    ct.firstName.isEmpty ? '?' : ct.firstName[0],
                ...
                subtitle: Text(
                  ct.primaryPhone == null
                      ? 'no phone'
                      : PhoneNumberUtil.format(ct.primaryPhone!),
    ...
    final calls = s.calls
        .where(
          (c) =>
              ...
              contact.phones.any((p) => p.e164 == c.remoteE164),
        )
        .take(8)
        .toList();
    final appts =
        ...
        Row(
          children: [
            CircleAvatar(
              radius: 26,
              child: Text(
                contact.firstName.isEmpty ? '?' : contact.firstName[0],
              ),
            ),
            ...
            IconButton(
              ...
              onPressed: () => repo.upsertContact(
                contact.copyWith(favorite: !contact.favorite),
              ),
            ),
            IconButton(
              tooltip: 'Archive',
              ...
              onPressed: () =>
                  repo.upsertContact(contact.copyWith(archived: true)),
            ),
          ],
        ),
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    Expanded(
                      child: TextFormField(
                        ...
                        onFieldSubmitted: (v) =>
                            repo.upsertContact(contact.copyWith(firstName: v)),
                      ),
                    ),
                    const SizedBox(width: 8),
                    Expanded(
                      child: TextFormField(
                        ...
                        onFieldSubmitted: (v) =>
                            repo.upsertContact(contact.copyWith(lastName: v)),
                      ),
                    ),
                  ],
                ),
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Notes (press Enter to save)',
                    isDense: true,
                  ),
                  onFieldSubmitted: (v) =>
                      repo.upsertContact(contact.copyWith(notes: v)),
                ),
              ],
            ),
          ),
              ...
              children: [
                ...
                for (final c in calls)
                  ListTile(
                    ...
                    title: Text(
                      '${c.direction.name} · ${c.disposition ?? c.finalState.name}',
                    ),
                    subtitle: Text(
