...
class Campaign {
  ...
  Campaign copyWith({CampaignStatus? status, List<String>? leadContactIds}) =>
      Campaign(
        id: id,
        name: name,
  ...
  factory Campaign.fromJson(Map<String, dynamic> j) => Campaign(
        ...
        objectionLibrary: (j['objectionLibrary'] as Map? ?? {}).map(
...
class AiAgent {
  ...
  const AiAgent({
    ...
    this.escalationConditions = const [
...
class DeviceRecord {
  ...
  Map<String, dynamic> toJson() => {
        ...
        'voicemailNotifications': voicemailNotifications,
        'revoked': revoked,
        'isThisDevice': isThisDevice,
      };
...
class IntegrationCard {
  ...
  final String
      category; // telephony | messaging | ai | transcription | calendar | crm
  ...
  IntegrationCard copyWith({
    ProviderState? state,
    DateTime? lastTestAt,
    String? lastTestResult,
    String? lastError,
    List<String>? configuredFieldNames,
  }) =>
      IntegrationCard(
        id: id,
        provider: provider,
  ...
  factory IntegrationCard.fromJson(Map<String, dynamic> j) => IntegrationCard(
        ...
        state: _enum(
            ProviderState.values, j['state'], ProviderState.notConfigured),
...
class AppNotification {
  ...
  factory AppNotification.fromJson(Map<String, dynamic> j) => AppNotification(
        ...
        title: _s(j['title']),
        body: _s(j['body']),
        at: DateTime.tryParse(_s(j['at'])) ?? DateTime.now(),
        read: _b(j['read']),
      );
}
